...
#define rIC_SLV_DATA_NACK_ONLY1	   	 (0x84 )     //generate slave data NACK register
#define rIC_DMA_CR1           		 (0x88 )     //DMA control register
#define rIC_DMA_TDLR1         		 (0x8C )     //DAM transmit data level register
#define rIC_DMA_RDLR1         		 (0x90 )     //IIC receive data level register
#define rIC_SDA_SETUP1        		 (0x94 )     //IIC SDA setup register
#define rIC_ACK_GENERAL_CALL1 		 (0x98 )     //IIC ACK general call register
#define rIC_ENABLE_STATUS1    		 (0x9C )     //IIC enable status register
#define rIC_IGNORE_ACK1    		 (0xA0 )     //IIC enable status register
...
#define IMAPX200_IIC_DEFAULT_SS_SCL_HCNT	(0xf0)
#define IMAPX200_IIC_DEFAULT_SS_SCL_LCNT	(0xf0)
#define IMAPX200_IIC_DEFAULT_SS_SCL_HCNT_SLOW	(0x180)
#define IMAPX200_IIC_DEFAULT_SS_SCL_LCNT_SLOW	(0x180)
...
#define IMAPX200_START_INT			(0x1<<10)
#define IMAPX200_STOP_INT			(0x1<<9)
#define IMAPX200_ACTIVITY_INT			(0x1<<8)
#define IMAPX200_IIC_ENABLE			(0x1)
#define IMAPX200_START_INT			(0x1<<10)
#define IMAPX200_STOP_INT			(0x1<<9)
#define IMAPX200_ACTIVITY_INT			(0x1<<8)
