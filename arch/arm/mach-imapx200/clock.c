...
void __init imapx200_init_clocks(int xtal)
{
	...
	//dpll_clk = imapx200_get_pll((0x1<<31| 0x1<<12 | 0x0<<7 | 0x2c), xtal);
	epll_clk = imapx200_get_pll((0x1<<31| 0x1<<12|0x0<<7 | 0x23), xtal);
	//epll_clk = imapx200_get_pll(__raw_readl(rEPLL_CFG), xtal);
//	__raw_writel((0x1<<31| 0x1<<12 | 0x0<<7 | 0x2c), rDPLL_CFG);	
